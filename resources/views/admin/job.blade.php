...
<div class="az-content-label mg-b-5">List Lowongan</div>
    <p class="mg-b-20">daftar semua lowongan kerja pada aplikasi JPC.</p>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('jobs.store') }}">
                        ...
                        <div class="form-group">
                            <label for="nama" class="col-form-label">Perusahaan</label>
                            <select class="form-control" name="id_user" id="id_user" required>
                                <option selected disabled>Pilih</option>
                                @foreach($companies as $c)
                                    <option value="{{ $c->id_user }}">{{ $c->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
    ...
    <div class="table-responsive">
        ...
        <table id="tableJob" class="table table-hover mg-b-0">
            ...
            <tbody>
                ...
                @foreach($jobs as $job)
                <?php
                    $c = \App\InfoCompany::firstWhere('id_user', $job->id_user);
                ?>
                <tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('jobs.update', ['job' => $job->id]) }}">
                                        ...
                                        <div class="form-group">
                                            <label for="nama" class="col-form-label">Perusahaan : </label>
                                            <?php $cmp = \App\InfoCompany::firstWhere('id_user', $job->id_user); ?>
                                            <strong>{{ $cmp->nama }}</strong>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama" class="col-form-label">Nama / Posisi</label>
