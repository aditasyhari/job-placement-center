        ...
        <div class="az-content-body">
          <div class="az-dashboard-one-title">
            <div>
              ...
              <p class="az-dashboard-text">Dashboard untuk perusahaan.</p>
            </div>
            <div class="az-content-header-right">
              ...
              <a href="{{route('C-profile')}}" class="btn btn-purple">Profile</a>
            </div>
          ...
          <div class="row row-sm mg-b-20">
            ...
            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
              <div class="card card-dashboard-four">
                <div class="card-header">
                  <h6 class="card-title">Chart Pelamar</h6>
                </div><!-- card-header -->
                <div class="card-body">
            ...
            <div class="col-lg-7 col-xl-8 mg-t-20 mg-lg-t-0">
              <div class="card card-table-one">
                <h6 class="card-title">Riwayat pelamar terakhir</h6>
                <p class="az-content-text mg-b-20">berikut ini riwayat pelamar lowongan pada perusahaan anda.</p>
                <div class="table-responsive">
                  <table class="table">
                    <thead>
                      <tr>
                        <th class="wd-5p">&nbsp;</th>
                        <th class="wd-45p">Nama</th>
                    ...
                    <tbody>
                      @foreach($apps as $app)
                        <?php 
                          ...
                          $c = \App\InfoUser::firstWhere('id_user', $app->id_pelamar);
                        ?>
                        <tr>
                          <td>
