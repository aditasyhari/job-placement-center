                        ...
                        <div class="hero-cap text-center">
                            <h2>
                                ...
                                @if($app->status == 'ditolak')
                                    (<span class="text-danger">{{ $app->status }}</span>)
                                @elseif($app->status == 'diterima')
                                    (<span class="text-success">{{ $app->status }}</span>)
                                @else
                                    (<span class="text-secondary">{{ $app->status }}</span>)
                                @endif
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="post-details3  mb-50">
                         ...
                         <div class="apply-btn2">
                            ...
                            <button type="button" class="btn btn-danger text-capitalize" disabled>{{ $app->status }}</a>
